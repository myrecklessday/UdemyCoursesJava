package section_11_packages_static_and_final_keywords.packages_challenge;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Series.factorial(6));
        System.out.println(Series.factorial(7));
        System.out.println(Series.factorial(8));
